 ...
 * prop' = "字段名";
 * sortable = true;  排序
 * filters = [["text" => "a", "value" => "aa"], ["text" => "b", "value" => "bb"]]; 表头过滤 【必须】添加column-key参数
 * children = []; //当前列的子组建 子组建中任何参数值都可以根据当前行的数据动态绑定 4种绑定格式
...
class TableColumn extends Component
{
     ...
     * 只支持绑定到第一级子组件
     *
     * $this->props([\surface\components\TableColumn::EVENT_CHANGE => $event]);
     *
     * @param array $event
     * [
